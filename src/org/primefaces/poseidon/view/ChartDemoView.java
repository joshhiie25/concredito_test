...
public class ChartDemoView implements Serializable {
    ...
    private void createPolarAreaModel() {
        ...
        gridLines.setColor("rgba(160, 167, 181, .3)");
    ...
    public void createLineModel() {
        ...
        AxesGridLines gridLines = new AxesGridLines();
        gridLines.setColor("rgba(160, 167, 181, .3)");
        gridLines.setZeroLineColor("rgba(160, 167, 181, .3)");
    ...
    public void createBarModel() {
        ...
        legendLabels.setFontColor("#A0A7B5");
    ...
    public void createRadarModel() {
        ...
        rAngleLines.setColor("rgba(160, 167, 181, .3)");
    ...
    public void createRadarModel2() {
        ...
        pointLabels.setFontColor("#A0A7B5");
